 ...
 * @description
 * js SVG Loader ported on npm by ghzmdr (https://github.com/ghzmdr)
 */
/* eslint-disable */

/* three-svg-loader mod */
import {DefaultLoadingManager, FileLoader, ShapePath, Vector2, Vector3, Float32BufferAttribute, Matrix3, Path, BufferGeometry} from 'three'
...
export default class SVGLoader {
    ...
    getStrokeStyle ( width, color, opacity, lineJoin, lineCap,  miterLimit ) {
    ...
    pointsToStroke ( points, style, arcDivisions, minDistance ) {
        ...
        if ( this.pointsToStrokeWithBuffers( points, style, arcDivisions, minDistance, vertices, normals, uvs ) === 0 ) {
